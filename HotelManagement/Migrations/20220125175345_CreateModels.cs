        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accomodations_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActiveAccomodations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActiveAccomodations_Accomodations_AccomodationId",
                        column: x => x.AccomodationId,
                        principalTable: "Accomodations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActiveAccomodations_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accomodations_RoomId",
                table: "Accomodations",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ActiveAccomodations_AccomodationId",
                table: "ActiveAccomodations",
                column: "AccomodationId");

            migrationBuilder.CreateIndex(
                name: "IX_ActiveAccomodations_RoomId",
                table: "ActiveAccomodations",
                column: "RoomId");
